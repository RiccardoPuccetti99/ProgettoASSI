...
Given("I have a guide with ID {int}") do |id|
  u = User.create!(:email=>"creator@case.com",
    :password => "password123",
    :uid => "creator",
    :roles_mask => 1 )
  guide = Guide.create!(:id=>id, 
    :title=>"Aatrox toplane",
    :champ_name=>"Aatrox",
    :champ_role=>"Toplane",
  ...
  When(/^I follow "Details" for guide with ID (\d+)$/) do |id|
    guide = Guide.find(id)
